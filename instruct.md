...
| Имя | IP | Создан |
|---|---|---|
| device1 | 10.8.1.2 | пример |
| device2 | 10.8.1.3 | пример |

> Список ведите у себя локально — в публичной инструкции реальные имена/даты
> клиентов не нужны (это метаданные о том, кто и когда подключался).
